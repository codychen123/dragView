...
Pod::Spec.new do |s|
  s.name             = 'myDragView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of myDragView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Xiaohuihui/myDragView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Xiaohuihui' => 'chhhithuihui@gmail.com' }
  s.source           = { :git => 'https://github.com/Xiaohuihui/myDragView.git', :tag => s.version.to_s }
